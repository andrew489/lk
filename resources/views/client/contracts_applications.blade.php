@extends('layouts.app')
@section('title', 'Кабинет клиента — Заявления по договорам')
@section('content')
<div class="d-flex align-center">
        <h2>Заявления по договорам</h2>
        <div class="spacer"></div>
        <a href="/client/contracts/create" class="v-btn v-btn--outlined"><span class="v-btn__content">Новый договор</span></a>
      </div>
